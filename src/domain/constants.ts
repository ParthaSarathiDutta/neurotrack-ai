...
/** Event detection (MS-5) — heuristic v1 defaults; versioned in EventDetectionParams. */
export const EVENT_INVESTIGATION_NOSE_PROXIMITY_FRACTION = 0.10;
export const EVENT_INVESTIGATION_BODY_PROXIMITY_FRACTION = 0.14;
export const EVENT_INVESTIGATION_MIN_DWELL_US = 400_000;
export const EVENT_INVESTIGATION_MERGE_GAP_US = 300_000;
export const EVENT_ESCAPE_PROXIMITY_FRACTION = 0.12;
export const EVENT_ESCAPE_MOTION_DECAY_RATIO = 0.35;
export const EVENT_ESCAPE_PROXIMITY_MIN_SPAN_US = 250_000;
export const EVENT_ESCAPE_CONFIRM_THRESHOLD = 0.75;
...
/** Body-entry completion (neurotrack_body_entry) — not full-animal disappearance. */
...
/** Occlusion-path progression: allow small darkening noise frame-to-frame. */
export const EVENT_BODY_ENTRY_DARKENING_PROGRESS_EPS = 0.01;
/** Occlusion-path progression: allow small platform-area noise (px²). */
export const EVENT_BODY_ENTRY_AREA_PROGRESS_PX = 5;
...
export const EVENT_STRATEGY_MAX_SERIAL_VIOLATIONS = 2;
export const EVENT_STRATEGY_CENTER_CROSSING_THRESHOLD = 2;
export const EVENT_STRATEGY_NONCENTRAL_START_FLAG_FRACTION = 0.35;
export const EVENT_STRATEGY_CLASSIFIER_VERSION = 'heuristic_v1';
