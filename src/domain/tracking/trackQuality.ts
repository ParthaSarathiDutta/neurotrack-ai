...
> = {
  ...
  speed_outlier_replaced: 'tracking_issues',
  gap_interpolated: 'tracking_issues',
  duplicate_pts_spatial_estimate: 'tracking_issues',
...
const REVIEW_REASON_LABELS: Record<FlaggedFrame['reason'], string> = {
  ...
  speed_outlier_replaced: 'speed outlier replaced (cleaning)',
  gap_interpolated: 'gap interpolated (cleaning)',
  duplicate_pts_spatial_estimate: 'duplicate PTS spatial estimate (cleaning)',
