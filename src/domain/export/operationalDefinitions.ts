...
export function buildOperationalDefinitionRows(params: AnalysisParams): OperationalDefinitionRow[] {
  ...
  return [
    ...
    {
      definitionId: 'speed_interval_validity.v1',
      definitionVersion: '1',
      definitionLabel: 'Speed interval validity',
      definitionSummary:
        'Exclude speed intervals with Δt below 5% of median in-trial container spacing (timestamp compression); path length unchanged (D12)',
      selectedVariant: 'median_reference_5pct',
      notes: 'Scientific mean/max speed use v2 definitions gated by this policy',
    },
    {
      definitionId: 'mean_speed.v2',
      definitionVersion: '2',
      definitionLabel: 'Mean speed',
      definitionSummary: 'Time-weighted mean over timestamp-quality-valid intervals',
      selectedVariant: 'time_weighted_mean_gated',
      notes: 'mean_speed.v1 superseded; unfiltered diagnostic exported separately',
    },
    {
      definitionId: 'max_speed.v2',
      definitionVersion: '2',
      definitionLabel: 'Max speed',
      definitionSummary: 'Max instantaneous speed over timestamp-quality-valid intervals',
      selectedVariant: 'max_quality_gated_interval',
      notes: 'max_speed.v1 superseded; max_speed_diagnostic.v1 preserves unfiltered D12 max',
    },
    {
      definitionId: 'mean_speed_diagnostic.v1',
      definitionVersion: '1',
      definitionLabel: 'Mean speed (unfiltered diagnostic)',
      definitionSummary: 'D12 time-weighted mean without timestamp-quality gate — not for primary reporting',
      selectedVariant: 'time_weighted_mean_raw',
      notes: null,
    },
    {
      ...
      definitionSummary: 'D12 max without timestamp-quality gate — not for primary reporting',
      selectedVariant: 'max_raw_interval',
      notes: null,
    },
    {
      definitionId: 'mean_speed.v1',
      definitionVersion: '1',
      definitionLabel: 'Mean speed (legacy)',
      definitionSummary: 'Superseded by mean_speed.v2 with speed_interval_validity.v1',
      selectedVariant: 'time_weighted_mean',
      notes: 'Legacy bundles may still store v1 until explicit recompute',
    },
    {
      definitionId: 'max_speed.v1',
      definitionVersion: '1',
      definitionLabel: 'Max speed (legacy)',
      definitionSummary: 'Superseded by max_speed.v2 with speed_interval_validity.v1',
